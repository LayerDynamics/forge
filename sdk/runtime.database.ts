...
export interface RawOpenResult {
  id: string;
  path: string;
  created: boolean;
}

export interface RawDatabaseInfo {
  name: string;
  path: string;
  size_bytes: number;
  tables: string[];
...
export interface RawExecuteResult {
  rows_affected: number;
  last_insert_rowid: number | null;
}
...
export interface RawPreparedStatementInfo {
  id: string;
  sql: string;
...
export interface RawStreamBatch {
  rows: unknown[][];
  done: boolean;
  total_fetched: number;
}

export interface RawAppliedMigration {
  version: number;
  name: string;
  applied_at: number;
}

export interface RawMigrationStatus {
...
interface OpRegistry {
  ...
  exists: { args: []; result: void };
  path: { args: []; result: void };
  vacuum: { args: []; result: void };
  query: { args: []; result: void };
  execute: { args: []; result: void };
  executeBatch: { args: []; result: void };
  queryRow: { args: []; result: void };
  queryValue: { args: []; result: void };
  prepare: { args: []; result: void };
  stmtQuery: { args: []; result: void };
  stmtExecute: { args: []; result: void };
  stmtFinalize: { args: []; result: void };
  begin: { args: []; result: void };
  commit: { args: []; result: void };
  rollback: { args: []; result: void };
  savepoint: { args: []; result: void };
  release: { args: []; result: void };
  rollbackTo: { args: []; result: void };
  tables: { args: []; result: void };
  tableInfo: { args: []; result: void };
  tableExists: { args: []; result: void };
  streamOpen: { args: []; result: void };
  streamNext: { args: []; result: void };
  streamClose: { args: []; result: void };
  migrate: { args: []; result: void };
  migrationStatus: { args: []; result: void };
  migrateDown: { args: []; result: void };
}
...
type OpName = "open" | "close" | "list" | "delete" | "exists" | "path" | "vacuum" | "query" | "execute" | "executeBatch" | "queryRow" | "queryValue" | "prepare" | "stmtQuery" | "stmtExecute" | "stmtFinalize" | "begin" | "commit" | "rollback" | "savepoint" | "release" | "rollbackTo" | "tables" | "tableInfo" | "tableExists" | "streamOpen" | "streamNext" | "streamClose" | "migrate" | "migrationStatus" | "migrateDown";
