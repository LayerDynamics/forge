...
interface OpRegistry {
  ...
  connect: { args: []; result: void };
  disconnect: { args: []; result: void };
  isConnected: { args: []; result: void };
  setBreakpoint: { args: []; result: void };
  removeBreakpoint: { args: []; result: void };
  removeAllBreakpoints: { args: []; result: void };
  listBreakpoints: { args: []; result: void };
  enableBreakpoint: { args: []; result: void };
  disableBreakpoint: { args: []; result: void };
  pause: { args: []; result: void };
  resume: { args: []; result: void };
  stepOver: { args: []; result: void };
  stepInto: { args: []; result: void };
  stepOut: { args: []; result: void };
  continueToLocation: { args: []; result: void };
  getCallFrames: { args: []; result: void };
  getScopeChain: { args: []; result: void };
  getProperties: { args: []; result: void };
  evaluate: { args: []; result: void };
  setVariableValue: { args: []; result: void };
  getScriptSource: { args: []; result: void };
  listScripts: { args: []; result: void };
  setPauseOnExceptions: { args: []; result: void };
  createPauseReceiver: { args: []; result: void };
  receivePauseEvent: { args: []; result: void };
  createScriptReceiver: { args: []; result: void };
  receiveScriptEvent: { args: []; result: void };
}
...
type OpName = "info" | "connect" | "disconnect" | "isConnected" | "setBreakpoint" | "removeBreakpoint" | "removeAllBreakpoints" | "listBreakpoints" | "enableBreakpoint" | "disableBreakpoint" | "pause" | "resume" | "stepOver" | "stepInto" | "stepOut" | "continueToLocation" | "getCallFrames" | "getScopeChain" | "getProperties" | "evaluate" | "setVariableValue" | "getScriptSource" | "listScripts" | "setPauseOnExceptions" | "createPauseReceiver" | "receivePauseEvent" | "createScriptReceiver" | "receiveScriptEvent";
