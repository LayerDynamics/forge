...
export interface ExecuteOptionsInternal {
  cwd?: string;
...
export interface ExecuteOutputResult {
  code: number;
  stdout: string;
  stderr: string;
}
...
interface OpRegistry {
  openExternal: { args: []; result: void };
  openPath: { args: []; result: void };
  showItemInFolder: { args: []; result: void };
  moveToTrash: { args: []; result: void };
  beep: { args: []; result: void };
  getFileIcon: { args: []; result: void };
  getDefaultApp: { args: []; result: void };
  execute: { args: []; result: void };
  kill: { args: []; result: void };
  cwd: { args: []; result: void };
  setCwd: { args: []; result: void };
  getEnv: { args: []; result: void };
  setEnv: { args: []; result: void };
  unsetEnv: { args: []; result: void };
  getAllEnv: { args: []; result: void };
  which: { args: []; result: void };
}
...
type OpName = "openExternal" | "openPath" | "showItemInFolder" | "moveToTrash" | "beep" | "getFileIcon" | "getDefaultApp" | "execute" | "kill" | "cwd" | "setCwd" | "getEnv" | "setEnv" | "unsetEnv" | "getAllEnv" | "which";
