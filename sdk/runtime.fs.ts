...
interface OpRegistry {
  readText: { args: []; result: void };
  writeText: { args: []; result: void };
  readBytes: { args: []; result: void };
  writeBytes: { args: []; result: void };
  stat: { args: []; result: void };
  readDir: { args: []; result: void };
  mkdir: { args: []; result: void };
  remove: { args: []; result: void };
  rename: { args: []; result: void };
  copy: { args: []; result: void };
  exists: { args: []; result: void };
  watch: { args: []; result: void };
  watchNext: { args: []; result: void };
  watchClose: { args: []; result: void };
  symlink: { args: []; result: void };
  readLink: { args: []; result: void };
  appendText: { args: []; result: void };
  appendBytes: { args: []; result: void };
  metadata: { args: []; result: void };
  realPath: { args: []; result: void };
  tempFile: { args: []; result: void };
...
type OpName = "readText" | "writeText" | "readBytes" | "writeBytes" | "stat" | "readDir" | "mkdir" | "remove" | "rename" | "copy" | "exists" | "watch" | "watchNext" | "watchClose" | "symlink" | "readLink" | "appendText" | "appendBytes" | "metadata" | "realPath" | "tempFile" | "tempDir";
