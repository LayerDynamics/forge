# runtime:ui API Reference

The `runtime:ui` module provides window management, dialogs, menus, and tray icon functionality.
...
```typescript
import { windowEvents } from "runtime:ui";
...
```typescript
import { openWindow, createTray, onMenu } from "runtime:ui";
