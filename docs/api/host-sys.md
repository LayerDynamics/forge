# host:sys API Reference

The `host:sys` module provides system-level operations including environment, clipboard, notifications, and system information.
