...
/// Adapter that implements ext_ui::UiCapabilityChecker using Capabilities
pub struct UiCapabilityAdapter {
    capabilities: Arc<Capabilities>,
}

impl UiCapabilityAdapter {
    pub fn new(capabilities: Arc<Capabilities>) -> Self {
        Self { capabilities }
    }
}

impl ext_ui::UiCapabilityChecker for UiCapabilityAdapter {
