...
The `host:window` module provides comprehensive window management including creation, manipulation, dialogs, menus, and system tray icons.
...
```typescript
import { createWindow, dialog, menu, tray, windowEvents } from "host:window";
