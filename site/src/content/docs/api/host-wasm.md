...
The `host:wasm` module provides WebAssembly support including module compilation, instantiation, function calls, memory access, and WASI integration.
...
```typescript
import { compileFile, instantiate, dropModule } from "host:wasm";
...
```typescript
import { compileFile, instantiate, dropModule, types } from "host:wasm";
