...
# Usage: curl -fsSL https://forge-deno.com/install.sh | sh
#
...
main() {
    ...
    echo ""
    echo "    # Clone the repo and copy an example"
    echo "    git clone https://github.com/LayerDynamics/forge.git"
    echo "    cp -r forge/examples/react-app my-app"
    echo "    cd my-app"
    echo "    forge dev ."
    echo ""
}
