...
<aside class="sidebar">
  ...
  <div class="sidebar-content">
    <div class="action-buttons">
      <button class="btn btn-primary" on:click={() => dispatch('newNote')}>
      ...
      <button class="btn btn-secondary" on:click={() => dispatch('addFile')}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <ul class="nav-list">
        <li>
          ...
          >
            ...
            <span class="nav-label">Encrypted Files</span>
          </button>
        </li>
      </ul>
    </nav>
